...
import { defaultMicrosoftHosts } from "../../adaptivecards-designer/src/adaptivecards-designer";
import * as ACDesigner from "../../adaptivecards-designer/src/shared";
import { SettingsManager } from "../../adaptivecards-designer/src/settings-manager";
import { FieldDefinition } from "../../adaptivecards-designer/src/data";
import * as Designer from "../../adaptivecards-designer/src/card-designer-surface";
import * as Data from "../../adaptivecards-designer/src/data";
...
window.onload = function () {
	...
	*/
	...
	CardDesigner.onProcessMarkdown = (text: string, result: { didProcess: boolean, outputHtml: string }) => {
	...
	*/
	...
	let designer = new CardDesigner(defaultMicrosoftHosts);
	...
	*/
	...
	let sampleDataStructure: Data.IData = {
		valueType: "Object",
		fields: [
			{
				name: "title",
	...
	*/
	...
	designer.dataStructure = FieldDefinition.parse(sampleDataStructure);
