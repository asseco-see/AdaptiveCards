[Adaptive Cards Javascript SDK](../README.md) / NumberInput
...
- [\_parent](NumberInput.md#_parent)
- [\_renderedElement](NumberInput.md#_renderedelement)
- [customCssSelector](NumberInput.md#customcssselector)
- [defaultValue](NumberInput.md#defaultvalue)
- [errorMessage](NumberInput.md#errormessage)
...
- [label](NumberInput.md#label)
- [max](NumberInput.md#max)
- [maxVersion](NumberInput.md#maxversion)
- [min](NumberInput.md#min)
- [onPreProcessPropertyValue](NumberInput.md#onpreprocesspropertyvalue)
- [onValueChanged](NumberInput.md#onvaluechanged)
- [placeholder](NumberInput.md#placeholder)
- [rules](NumberInput.md#rules)
- [separator](NumberInput.md#separator)
- [spacing](NumberInput.md#spacing)
- [errorMessageProperty](NumberInput.md#errormessageproperty)
- [heightProperty](NumberInput.md#heightproperty)
- [horizontalAlignmentProperty](NumberInput.md#horizontalalignmentproperty)
- [idProperty](NumberInput.md#idproperty)
- [isRequiredProperty](NumberInput.md#isrequiredproperty)
- [isVisibleProperty](NumberInput.md#isvisibleproperty)
- [labelProperty](NumberInput.md#labelproperty)
- [langProperty](NumberInput.md#langproperty)
- [maxProperty](NumberInput.md#maxproperty)
- [minProperty](NumberInput.md#minproperty)
- [onRegisterCustomProperties](NumberInput.md#onregistercustomproperties)
- [placeholderProperty](NumberInput.md#placeholderproperty)
- [requiresProperty](NumberInput.md#requiresproperty)
- [rulesProperty](NumberInput.md#rulesproperty)
- [separatorProperty](NumberInput.md#separatorproperty)
- [spacingProperty](NumberInput.md#spacingproperty)
- [typeNameProperty](NumberInput.md#typenameproperty)
- [valueProperty](NumberInput.md#valueproperty)

### Accessors

- [allowCustomPadding](NumberInput.md#allowcustompadding)
- [defaultStyle](NumberInput.md#defaultstyle)
- [hasVisibleSeparator](NumberInput.md#hasvisibleseparator)
- [hostConfig](NumberInput.md#hostconfig)
- [index](NumberInput.md#index)
- [inputControlContainerElement](NumberInput.md#inputcontrolcontainerelement)
- [isInline](NumberInput.md#isinline)
- [isInteractive](NumberInput.md#isinteractive)
- [isNullable](NumberInput.md#isnullable)
...
- [renderedInputControlElement](NumberInput.md#renderedinputcontrolelement)
- [requires](NumberInput.md#requires)
- [separatorElement](NumberInput.md#separatorelement)
- [separatorOrientation](NumberInput.md#separatororientation)
- [useDefaultSizing](NumberInput.md#usedefaultsizing)
- [value](NumberInput.md#value)

### Methods

- [adjustRenderedElementSize](NumberInput.md#adjustrenderedelementsize)
- [applyPadding](NumberInput.md#applypadding)
- [asString](NumberInput.md#asstring)
- [createPlaceholderElement](NumberInput.md#createplaceholderelement)
...
- [getAllLabelIds](NumberInput.md#getalllabelids)
- [getCustomProperty](NumberInput.md#getcustomproperty)
- [getDefaultPadding](NumberInput.md#getdefaultpadding)
- [getDefaultSerializationContext](NumberInput.md#getdefaultserializationcontext)
...
- [getHasBackground](NumberInput.md#gethasbackground)
...
- [getPadding](NumberInput.md#getpadding)
...
- [getSchemaKey](NumberInput.md#getschemakey)
- [getValue](NumberInput.md#getvalue)
...
- [internalParse](NumberInput.md#internalparse)
- [internalRender](NumberInput.md#internalrender)
- [internalToJSON](NumberInput.md#internaltojson)
...
- [isDisplayed](NumberInput.md#isdisplayed)
...
- [overrideInternalRender](NumberInput.md#overrideinternalrender)
- [parse](NumberInput.md#parse)
- [populateSchema](NumberInput.md#populateschema)
...
- [resetValidationFailureCue](NumberInput.md#resetvalidationfailurecue)
- [setCustomProperty](NumberInput.md#setcustomproperty)
- [setPadding](NumberInput.md#setpadding)
- [setParent](NumberInput.md#setparent)
- [setShouldFallback](NumberInput.md#setshouldfallback)
- [setValue](NumberInput.md#setvalue)
- [shouldFallback](NumberInput.md#shouldfallback)
- [shouldSerialize](NumberInput.md#shouldserialize)
- [showValidationErrorMessage](NumberInput.md#showvalidationerrormessage)
- [toJSON](NumberInput.md#tojson)
- [truncateOverflow](NumberInput.md#truncateoverflow)
- [undoOverflowTruncation](NumberInput.md#undooverflowtruncation)
- [updateInputControlAriaLabelledBy](NumberInput.md#updateinputcontrolarialabelledby)
...
- [valueChanged](NumberInput.md#valuechanged)
...
[card-elements.ts:3481](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3481)
...
[card-elements.ts:3487](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3487)
...
[card-elements.ts:3484](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3484)
...
[card-elements.ts:3490](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3490)
...
[card-elements.ts:3478](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3478)
...
[card-elements.ts:3477](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3477)
...
[card-elements.ts:3476](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3476)
...
▪ `Static` `Readonly` **valueProperty**: [`NumProperty`](NumProperty.md)

#### Defined in

[card-elements.ts:3475](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3475)
...
[card-elements.ts:3552](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3552)
...
[card-elements.ts:3526](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3526)
...
[card-elements.ts:3496](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3496)
...
[card-elements.ts:3530](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3530)
...
[card-elements.ts:3534](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3534)
