[Adaptive Cards Javascript SDK](../README.md) / ComponentSchema
...
- [maxVersion](ComponentSchema.md#maxversion)
- [properties](ComponentSchema.md#properties)
- [onRegisterCustomProperties](ComponentSchema.md#onregistercustomproperties)
- [propertiesProperty](ComponentSchema.md#propertiesproperty)

### Methods

- [getCustomProperty](ComponentSchema.md#getcustomproperty)
- [getDefaultSerializationContext](ComponentSchema.md#getdefaultserializationcontext)
- [getSchema](ComponentSchema.md#getschema)
- [getSchemaKey](ComponentSchema.md#getschemakey)
- [getValue](ComponentSchema.md#getvalue)
- [hasAllDefaultValues](ComponentSchema.md#hasalldefaultvalues)
- [hasDefaultValue](ComponentSchema.md#hasdefaultvalue)
- [internalParse](ComponentSchema.md#internalparse)
- [internalToJSON](ComponentSchema.md#internaltojson)
- [parse](ComponentSchema.md#parse)
- [populateSchema](ComponentSchema.md#populateschema)
- [resetDefaultValues](ComponentSchema.md#resetdefaultvalues)
- [setCustomProperty](ComponentSchema.md#setcustomproperty)
- [setValue](ComponentSchema.md#setvalue)
- [shouldSerialize](ComponentSchema.md#shouldserialize)
- [toJSON](ComponentSchema.md#tojson)
...
[components.ts:157](https://github.com/asseco-see/AdaptiveCards/blob/d5d2c7b75/source/nodejs/adaptivecards/src/components.ts#L157)
...
▪ `Static` `Readonly` **propertiesProperty**: [`SchemaPropertiesProperty`](SchemaPropertiesProperty.md)

#### Defined in

[components.ts:154](https://github.com/asseco-see/AdaptiveCards/blob/d5d2c7b75/source/nodejs/adaptivecards/src/components.ts#L154)
...
[components.ts:161](https://github.com/asseco-see/AdaptiveCards/blob/d5d2c7b75/source/nodejs/adaptivecards/src/components.ts#L161)
