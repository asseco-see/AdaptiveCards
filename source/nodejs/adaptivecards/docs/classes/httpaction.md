[Adaptive Cards Javascript SDK](../README.md) / HttpAction
...
- [\_parent](HttpAction.md#_parent)
- [\_renderedElement](HttpAction.md#_renderedelement)
...
- [onPreProcessPropertyValue](HttpAction.md#onpreprocesspropertyvalue)
- [rules](HttpAction.md#rules)
- [style](HttpAction.md#style)
- [title](HttpAction.md#title)
- [JsonTypeName](HttpAction.md#jsontypename)
- [bodyProperty](HttpAction.md#bodyproperty)
- [headersProperty](HttpAction.md#headersproperty)
- [iconUrlProperty](HttpAction.md#iconurlproperty)
- [idProperty](HttpAction.md#idproperty)
- [ignoreInputValidationProperty](HttpAction.md#ignoreinputvalidationproperty)
- [methodProperty](HttpAction.md#methodproperty)
- [onRegisterCustomProperties](HttpAction.md#onregistercustomproperties)
- [requiresProperty](HttpAction.md#requiresproperty)
- [rulesProperty](HttpAction.md#rulesproperty)
- [styleProperty](HttpAction.md#styleproperty)
- [titleProperty](HttpAction.md#titleproperty)
- [typeNameProperty](HttpAction.md#typenameproperty)
- [urlProperty](HttpAction.md#urlproperty)
...
- [addCssClasses](HttpAction.md#addcssclasses)
...
- [getDefaultSerializationContext](HttpAction.md#getdefaultserializationcontext)
...
- [getSchemaKey](HttpAction.md#getschemakey)
- [getValue](HttpAction.md#getvalue)
- [hasAllDefaultValues](HttpAction.md#hasalldefaultvalues)
- [hasDefaultValue](HttpAction.md#hasdefaultvalue)
- [internalGetReferencedInputs](HttpAction.md#internalgetreferencedinputs)
- [internalParse](HttpAction.md#internalparse)
- [internalPrepareForExecution](HttpAction.md#internalprepareforexecution)
- [internalToJSON](HttpAction.md#internaltojson)
- [internalValidateInputs](HttpAction.md#internalvalidateinputs)
- [internalValidateProperties](HttpAction.md#internalvalidateproperties)
- [parse](HttpAction.md#parse)
- [populateSchema](HttpAction.md#populateschema)
- [preProcessPropertyValue](HttpAction.md#preprocesspropertyvalue)
- [prepareForExecution](HttpAction.md#prepareforexecution)
- [raiseExecuteActionEvent](HttpAction.md#raiseexecuteactionevent)
...
- [setValue](HttpAction.md#setvalue)
- [shouldFallback](HttpAction.md#shouldfallback)
- [shouldSerialize](HttpAction.md#shouldserialize)
...
[card-elements.ts:4632](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4632)
...
[card-elements.ts:4629](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4629)
...
[card-elements.ts:4641](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4641)
...
[card-elements.ts:4611](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4611)

___

### headersProperty

▪ `Static` `Readonly` **headersProperty**: [`SerializableObjectCollectionProperty`](SerializableObjectCollectionProperty.md)

#### Defined in

[card-elements.ts:4613](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4613)
...
[card-elements.ts:4614](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4614)

___

### methodProperty

▪ `Static` `Readonly` **methodProperty**: [`StringProperty`](StringProperty.md)

#### Defined in

[card-elements.ts:4612](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4612)
...
[card-elements.ts:4610](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4610)
...
[card-elements.ts:4718](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4718)
...
[card-elements.ts:4722](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4722)
...
[card-elements.ts:4702](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4702)
...
[card-elements.ts:4706](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4706)
...
[card-elements.ts:4710](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4710)
...
[card-elements.ts:4714](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4714)
...
[card-elements.ts:4676](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4676)
...
[card-elements.ts:4643](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4643)
...
[card-elements.ts:4658](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4658)
...
[card-elements.ts:4680](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4680)
...
[card-elements.ts:4616](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L4616)
