[Adaptive Cards Javascript SDK](../README.md) / ToggleInput
...
- [\_parent](ToggleInput.md#_parent)
- [\_renderedElement](ToggleInput.md#_renderedelement)
- [customCssSelector](ToggleInput.md#customcssselector)
- [defaultValue](ToggleInput.md#defaultvalue)
- [errorMessage](ToggleInput.md#errormessage)
...
- [label](ToggleInput.md#label)
- [maxVersion](ToggleInput.md#maxversion)
- [onPreProcessPropertyValue](ToggleInput.md#onpreprocesspropertyvalue)
- [onValueChanged](ToggleInput.md#onvaluechanged)
- [rules](ToggleInput.md#rules)
...
- [errorMessageProperty](ToggleInput.md#errormessageproperty)
- [heightProperty](ToggleInput.md#heightproperty)
- [horizontalAlignmentProperty](ToggleInput.md#horizontalalignmentproperty)
- [idProperty](ToggleInput.md#idproperty)
- [isRequiredProperty](ToggleInput.md#isrequiredproperty)
- [isVisibleProperty](ToggleInput.md#isvisibleproperty)
- [labelProperty](ToggleInput.md#labelproperty)
- [langProperty](ToggleInput.md#langproperty)
- [onRegisterCustomProperties](ToggleInput.md#onregistercustomproperties)
- [requiresProperty](ToggleInput.md#requiresproperty)
- [rulesProperty](ToggleInput.md#rulesproperty)
- [separatorProperty](ToggleInput.md#separatorproperty)
- [spacingProperty](ToggleInput.md#spacingproperty)
- [titleProperty](ToggleInput.md#titleproperty)
- [typeNameProperty](ToggleInput.md#typenameproperty)
- [valueOffProperty](ToggleInput.md#valueoffproperty)
- [valueOnProperty](ToggleInput.md#valueonproperty)
- [valueProperty](ToggleInput.md#valueproperty)
- [wrapProperty](ToggleInput.md#wrapproperty)

### Accessors

- [allowCustomPadding](ToggleInput.md#allowcustompadding)
- [defaultStyle](ToggleInput.md#defaultstyle)
- [hasVisibleSeparator](ToggleInput.md#hasvisibleseparator)
- [hostConfig](ToggleInput.md#hostconfig)
- [index](ToggleInput.md#index)
- [inputControlContainerElement](ToggleInput.md#inputcontrolcontainerelement)
- [isInline](ToggleInput.md#isinline)
- [isInteractive](ToggleInput.md#isinteractive)
- [isNullable](ToggleInput.md#isnullable)
...
- [renderedInputControlElement](ToggleInput.md#renderedinputcontrolelement)
- [requires](ToggleInput.md#requires)
- [separatorElement](ToggleInput.md#separatorelement)
- [separatorOrientation](ToggleInput.md#separatororientation)
- [useDefaultSizing](ToggleInput.md#usedefaultsizing)
- [value](ToggleInput.md#value)

### Methods

- [adjustRenderedElementSize](ToggleInput.md#adjustrenderedelementsize)
- [applyPadding](ToggleInput.md#applypadding)
- [asString](ToggleInput.md#asstring)
- [createPlaceholderElement](ToggleInput.md#createplaceholderelement)
...
- [getAllLabelIds](ToggleInput.md#getalllabelids)
- [getCustomProperty](ToggleInput.md#getcustomproperty)
- [getDefaultPadding](ToggleInput.md#getdefaultpadding)
- [getDefaultSerializationContext](ToggleInput.md#getdefaultserializationcontext)
...
- [getHasBackground](ToggleInput.md#gethasbackground)
...
- [getPadding](ToggleInput.md#getpadding)
...
- [getSchemaKey](ToggleInput.md#getschemakey)
- [getValue](ToggleInput.md#getvalue)
...
- [internalParse](ToggleInput.md#internalparse)
- [internalRender](ToggleInput.md#internalrender)
- [internalToJSON](ToggleInput.md#internaltojson)
...
- [isDisplayed](ToggleInput.md#isdisplayed)
...
- [overrideInternalRender](ToggleInput.md#overrideinternalrender)
- [parse](ToggleInput.md#parse)
- [populateSchema](ToggleInput.md#populateschema)
...
- [resetValidationFailureCue](ToggleInput.md#resetvalidationfailurecue)
- [setCustomProperty](ToggleInput.md#setcustomproperty)
- [setPadding](ToggleInput.md#setpadding)
- [setParent](ToggleInput.md#setparent)
- [setShouldFallback](ToggleInput.md#setshouldfallback)
- [setValue](ToggleInput.md#setvalue)
- [shouldFallback](ToggleInput.md#shouldfallback)
- [shouldSerialize](ToggleInput.md#shouldserialize)
- [showValidationErrorMessage](ToggleInput.md#showvalidationerrormessage)
- [toJSON](ToggleInput.md#tojson)
- [truncateOverflow](ToggleInput.md#truncateoverflow)
- [undoOverflowTruncation](ToggleInput.md#undooverflowtruncation)
- [updateInputControlAriaLabelledBy](ToggleInput.md#updateinputcontrolarialabelledby)
...
- [valueChanged](ToggleInput.md#valuechanged)
...
[card-elements.ts:2950](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2950)
...
[card-elements.ts:2953](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2953)
...
[card-elements.ts:2959](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2959)
...
[card-elements.ts:2956](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2956)
...
[card-elements.ts:2962](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2962)
...
[card-elements.ts:2944](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2944)
...
▪ `Static` `Readonly` **valueOffProperty**: [`StringProperty`](StringProperty.md)

#### Defined in

[card-elements.ts:2946](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2946)

___

### valueOnProperty

▪ `Static` `Readonly` **valueOnProperty**: [`StringProperty`](StringProperty.md)

#### Defined in

[card-elements.ts:2945](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2945)
...
[card-elements.ts:2943](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2943)
...
[card-elements.ts:2947](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2947)
...
[card-elements.ts:3048](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3048)
...
[card-elements.ts:3070](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3070)
...
[card-elements.ts:3056](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3056)
...
[card-elements.ts:3052](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3052)
...
[card-elements.ts:2986](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2986)
...
[card-elements.ts:3062](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L3062)
...
[card-elements.ts:2969](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L2969)
