[Adaptive Cards Javascript SDK](../README.md) / RichTextBlock
...
- [constructor](RichTextBlock.md#constructor)

### Properties

- [\_parent](RichTextBlock.md#_parent)
- [\_renderedElement](RichTextBlock.md#_renderedelement)
- [customCssSelector](RichTextBlock.md#customcssselector)
- [forElementId](RichTextBlock.md#forelementid)
- [height](RichTextBlock.md#height)
- [horizontalAlignment](RichTextBlock.md#horizontalalignment)
- [id](RichTextBlock.md#id)
- [maxVersion](RichTextBlock.md#maxversion)
- [onPreProcessPropertyValue](RichTextBlock.md#onpreprocesspropertyvalue)
- [rules](RichTextBlock.md#rules)
- [separator](RichTextBlock.md#separator)
- [spacing](RichTextBlock.md#spacing)
- [heightProperty](RichTextBlock.md#heightproperty)
- [horizontalAlignmentProperty](RichTextBlock.md#horizontalalignmentproperty)
- [idProperty](RichTextBlock.md#idproperty)
- [isVisibleProperty](RichTextBlock.md#isvisibleproperty)
- [langProperty](RichTextBlock.md#langproperty)
- [onRegisterCustomProperties](RichTextBlock.md#onregistercustomproperties)
- [requiresProperty](RichTextBlock.md#requiresproperty)
- [rulesProperty](RichTextBlock.md#rulesproperty)
- [separatorProperty](RichTextBlock.md#separatorproperty)
- [spacingProperty](RichTextBlock.md#spacingproperty)
- [typeNameProperty](RichTextBlock.md#typenameproperty)

### Accessors

- [allowCustomPadding](RichTextBlock.md#allowcustompadding)
- [defaultStyle](RichTextBlock.md#defaultstyle)
...
- [separatorOrientation](RichTextBlock.md#separatororientation)
- [useDefaultSizing](RichTextBlock.md#usedefaultsizing)

### Methods

- [addInline](RichTextBlock.md#addinline)
- [adjustRenderedElementSize](RichTextBlock.md#adjustrenderedelementsize)
- [applyPadding](RichTextBlock.md#applypadding)
- [asString](RichTextBlock.md#asstring)
- [createPlaceholderElement](RichTextBlock.md#createplaceholderelement)
...
- [getDefaultPadding](RichTextBlock.md#getdefaultpadding)
- [getDefaultSerializationContext](RichTextBlock.md#getdefaultserializationcontext)
- [getEffectivePadding](RichTextBlock.md#geteffectivepadding)
- [getEffectiveStyle](RichTextBlock.md#geteffectivestyle)
- [getEffectiveStyleDefinition](RichTextBlock.md#geteffectivestyledefinition)
- [getElementById](RichTextBlock.md#getelementbyid)
- [getForbiddenActionTypes](RichTextBlock.md#getforbiddenactiontypes)
- [getHasBackground](RichTextBlock.md#gethasbackground)
...
- [getPadding](RichTextBlock.md#getpadding)
...
- [getRootObject](RichTextBlock.md#getrootobject)
- [getSchema](RichTextBlock.md#getschema)
- [getSchemaKey](RichTextBlock.md#getschemakey)
- [getValue](RichTextBlock.md#getvalue)
- [hasAllDefaultValues](RichTextBlock.md#hasalldefaultvalues)
- [hasDefaultValue](RichTextBlock.md#hasdefaultvalue)
- [indexOf](RichTextBlock.md#indexof)
- [internalParse](RichTextBlock.md#internalparse)
- [internalRender](RichTextBlock.md#internalrender)
- [internalToJSON](RichTextBlock.md#internaltojson)
...
- [isDisplayed](RichTextBlock.md#isdisplayed)
...
- [overrideInternalRender](RichTextBlock.md#overrideinternalrender)
- [parse](RichTextBlock.md#parse)
- [populateSchema](RichTextBlock.md#populateschema)
- [preProcessPropertyValue](RichTextBlock.md#preprocesspropertyvalue)
- [remove](RichTextBlock.md#remove)
- [removeInline](RichTextBlock.md#removeinline)
- [render](RichTextBlock.md#render)
- [resetDefaultValues](RichTextBlock.md#resetdefaultvalues)
- [setCustomProperty](RichTextBlock.md#setcustomproperty)
- [setPadding](RichTextBlock.md#setpadding)
- [setParent](RichTextBlock.md#setparent)
- [setShouldFallback](RichTextBlock.md#setshouldfallback)
- [setValue](RichTextBlock.md#setvalue)
- [shouldFallback](RichTextBlock.md#shouldfallback)
- [shouldSerialize](RichTextBlock.md#shouldserialize)
- [toJSON](RichTextBlock.md#tojson)
- [truncateOverflow](RichTextBlock.md#truncateoverflow)
- [undoOverflowTruncation](RichTextBlock.md#undooverflowtruncation)
...
[card-elements.ts:1449](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L1449)
...
▸ **addInline**(`inline`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `inline` | `string` \| [`CardElement`](CardElement.md) |
...
[card-elements.ts:1478](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L1478)
...
[card-elements.ts:1451](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L1451)
...
▸ **getInlineAt**(`index`): [`CardElement`](CardElement.md)
...
[card-elements.ts:1469](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L1469)
...
[card-elements.ts:1465](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L1465)
...
[card-elements.ts:1461](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L1461)
...
[card-elements.ts:1357](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L1357)
...
[card-elements.ts:1398](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L1398)
...
[card-elements.ts:1384](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L1384)
...
[card-elements.ts:1487](https://github.com/asseco-see/AdaptiveCards/blob/1f0afdc45/source/nodejs/adaptivecards/src/card-elements.ts#L1487)
